      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 pb-12 max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <div className="pt-4 flex gap-4">
            ...
            <Button size="lg" variant="outline" className="text-white border-white/30 bg-transparent hover:bg-transparent active:bg-transparent focus:bg-transparent backdrop-blur-sm transition-all hover:scale-105 active:scale-95">
              Watch Live
            </Button>
          </div>
        </motion.div>
